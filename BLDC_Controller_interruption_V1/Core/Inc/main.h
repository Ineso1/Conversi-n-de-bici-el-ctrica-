...
#define H_B_Pin GPIO_PIN_6
#define H_B_GPIO_Port GPIOA
...
#define H_C_Pin GPIO_PIN_11
#define H_C_GPIO_Port GPIOA
#define L_C_Pin GPIO_PIN_12
#define L_C_GPIO_Port GPIOA
